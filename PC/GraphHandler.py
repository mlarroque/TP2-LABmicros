...
class GraphHandler(object):
    ...
    def __init__(self):
        ...
        self.ax1 = self.fig.add_subplot(331, projection='3d', title = "Kinetis 1");
        self.ax2 = self.fig.add_subplot(332, projection='3d', title = "Kinetis 2");
        self.ax3 = self.fig.add_subplot(333, projection='3d', title = "Kinetis 3");
        self.ax4 = self.fig.add_subplot(334, projection='3d', title = "Kinetis 4");
        self.ax5 = self.fig.add_subplot(335, projection='3d', title = "Kinetis 5");
        self.ax6 = self.fig.add_subplot(336, projection='3d', title = "Kinetis 6");
        ...
        rect5 = Rectangle( (bottom_left_x,bottom_left_y), width, height, angle=0.0);
        rect6 = Rectangle( (bottom_left_x,bottom_left_y), width, height, angle=0.0);

        self.ax1.add_patch(rect1);
        self.ax2.add_patch(rect2); 
        self.ax3.add_patch(rect3);
        self.ax4.add_patch(rect4);
        self.ax5.add_patch(rect5);
        self.ax6.add_patch(rect6);
        ...
        art3d.pathpatch_2d_to_3d(rect5, z=1, zdir='y');
        art3d.pathpatch_2d_to_3d(rect6, z=1, zdir='y');
